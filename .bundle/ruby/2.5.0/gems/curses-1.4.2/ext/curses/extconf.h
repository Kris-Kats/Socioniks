...
#define SIZEOF_CHTYPE SIZEOF_UNSIGNED_LONG
#define TYPEOF_CHTYPE unsigned long
#define PRI_CHTYPE_PREFIX PRI_LONG_PREFIX
#define CHTYPE2NUM ULONG2NUM
#define NUM2CHTYPE NUM2ULONG
